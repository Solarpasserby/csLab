...
typedef struct Pipe_State {
    ...
    int inst_cache_miss_stall; /* number of cycles to stall for an instruction cache miss */
    int data_cache_miss_stall; /* number of cycles to stall for a data cache miss */
